    ...
    <div style={containerStyle}>
      <div style={contentWrapperStyle}>
        ...
        <p style={descriptionStyle}>
          Join the IEEE CIS REC Computational Society to dive into domains like AI, Machine Learning,
          and Robotics. Shape the future, learn from experts, and collaborate on real-world projects.
        </p>
